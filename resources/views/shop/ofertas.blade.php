    ...
    <div class="flex flex-col md:flex-row gap-6 md:gap-8">
        <aside class="w-full md:w-72 flex-shrink-0">
            <div class="rounded-2xl md:rounded-[2rem] border border-line bg-surface p-4 md:p-6 shadow-sm">
                <span class="text-[10px] md:text-[11px] font-bold uppercase tracking-[0.24em] text-sting">Colecciones</span>
                <h2 class="text-lg md:text-xl font-display font-bold uppercase tracking-[-0.01em] text-bone mt-1 md:mt-3">Ofertas</h2>
                ...
                <ul class="flex md:flex-col gap-2 overflow-x-auto pb-2 md:pb-0 mt-4 md:mt-6 no-scrollbar -mx-2 px-2 md:mx-0 md:px-0">
                    <li class="flex-shrink-0">
                        <a href="{{ route('shop.ofertas') }}"
                           class="inline-block md:block px-4 py-2 text-xs md:text-sm font-medium rounded-full transition-colors whitespace-nowrap bg-sting text-ink shadow-sm">
                            Precio bajo
                        </a>
                    </li>
                </ul>
        ...
        <div class="flex-1">
            <div class="flex flex-wrap items-center justify-between gap-3 mb-6 md:mb-8">
                <div>
                    <span class="text-[10px] md:text-[11px] font-bold uppercase tracking-[0.24em] text-sting">Ofertas</span>
            ...
            <div class="grid grid-cols-2 lg:grid-cols-3 gap-3 md:gap-8">
                ...
                <a href="{{ route('shop.show', $product->id) }}"
                   class="group block rounded-2xl md:rounded-[2rem] border border-line bg-surface p-2 md:p-3 shadow-sm hover:shadow-lg hover:shadow-sting/5 hover:border-sting/30 hover:-translate-y-1 transition-all duration-300">
                    <div class="aspect-[3/4] w-full rounded-xl md:rounded-[1.5rem] overflow-hidden bg-surface-2 relative">
                        <span class="absolute top-2 left-2 md:top-3 md:left-3 bg-sting text-ink text-[9px] md:text-[10px] font-black px-2.5 py-1 md:px-3 md:py-1.5 uppercase rounded-full z-10">
                            Oferta
                        </span>
                    ...
                    <div class="px-1 md:px-2 pt-3 md:pt-4">
                        <h3 class="text-xs md:text-sm font-bold uppercase tracking-[0.05em] md:tracking-[0.1em] text-bone group-hover:text-sting line-clamp-1">
                            {{ $product->name }}
                        </h3>
                ...
                <div class="col-span-full text-center text-bone-dim py-12 md:py-16 rounded-2xl md:rounded-[2rem] border border-dashed border-line bg-surface">
                    <p class="text-sm md:text-base">No hay descuentos disponibles.</p>
                </div>
                @endforelse
            </div>
